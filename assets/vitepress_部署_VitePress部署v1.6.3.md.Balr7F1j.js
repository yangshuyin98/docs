...
<span class="line"><span>git remote add origin https://github.com</span></span>
<span class="line"><span>git push -u origin main</span></span></code></pre></div><p>git push origin main</p><p>git commit -m &quot;更新文件&quot;</p><p>git commit -m &quot;更新文件&quot;</p><p>git add .</p><p>git push origin main</p><h5 id="_6-选择github-actions" tabindex="-1">6.选择github actions <a class="header-anchor" href="#_6-选择github-actions" aria-label="Permalink to &quot;6.选择github actions&quot;">​</a></h5><p>Actions→</p><p>Get started with GitHub Actions→</p><p>Skip this and set up a workflow yourself →</p><h5 id="_7-设置工作流" tabindex="-1">7.设置工作流 <a class="header-anchor" href="#_7-设置工作流" aria-label="Permalink to &quot;7.设置工作流&quot;">​</a></h5><p>重命名并设置deploy.yml脚本 脚本文件：参考的vitepress官方文档：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>https://vitepress.dev/guide/deploy#github-pages</span></span></code></pre></div><p>**这里发现参考资料里面的node包有问题,换成我们的</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 定义工作流名称为“部署 VitePress 站点到 Pages”</span></span>
