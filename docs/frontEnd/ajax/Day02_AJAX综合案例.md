...
3. 如何使用 Bootstrap 弹框呢？
   ...
   2. 准备弹框标签，确认结构（可以从 Bootstrap 官方文档的 Modal 里复制基础例子）- 运行到网页后，逐一对应标签和弹框每个部分对应关系
      ...
      ```html
      <!-- 弹框标签    bootstrap的modal弹框，添加modal类名（默认隐藏）-->
      ...
      data-bs-dismiss="modal"         关闭的是标签所在的当前提示框

   3. 通过自定义属性，控制通知弹框的显示和隐藏，语法如下：
      ...
      data-bs-toggle="modal"         显示的是标签所在的当前提示框，

      data-bs-target="css选择器"     选择对应的css选择器弹框
...
![必要商城分类](images/%E5%BF%85%E8%A6%81%E5%95%86%E5%9F%8E%E5%88%86%E7%B1%BB.gif)
